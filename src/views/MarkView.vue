        ...
        <section class="px-20 py-10 grid grid-cols-8 gap-6">
            <router-link :to="`/detail`"
                ...
                <div class="image h-[75%] flex justify-center rounded bg-gray-100">
                    <img src="/default_cover.png" class="h-full rounded" alt="cover_buku">
                </div>
                <div class="text">
                    <h5 class="w-max px-2 py-1 my-2 text-blue-500 text-xs font-semibold rounded bg-blue-100">Tersedia
                    </h5>
                    <!-- <h5 v-if="book.status == 2"
                        class="w-max px-2 py-1 my-2 text-red-500 text-xs font-semibold rounded bg-red-100">
                        Tidak Tersedia</h5> -->
                    <h3 class="text-gray-500 text-xs font-medium">Penulis</h3>
                    <h1 class="font-semibold truncate">Judul Buku</h1>
                </div>
            </router-link>
        </section>
