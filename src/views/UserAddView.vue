<template>
    <main class="h-full flex">
        ...
        <section class="w-5/6 px-5 py-4 bg-[#eaeaea]">
            <h1 class="py-3 text-xl font-semibold">Tambah Pengguna</h1>
            ...
            <div class="w-1/3 h-fit p-4 mt-2 bg-white flex flex-col rounded">
                <form @submit.prevent="userAdd">
                    <div class="username flex flex-col">
                        ...
                        <input type="text" v-model="username" name="username" id="username" autocomplete="off"
                    ...
                    <div class="email flex flex-col">
                        ...
                        <input type="email" v-model="email" name="email" id="email"
                            ...
                            class="px-2 py-1 mt-2 bg-[#eaeaea] rounded focus:outline-none border-2 border-gray-100 focus:border-blue-500">
                        <div class="message h-6">
                            <small v-if="errors.email" class="text-red-500 font-semibold">{{ errors.email[0]
                                }}</small>
                        </div>
                    </div>
                    ...
                    <div class="phone flex flex-col">
                        ...
                        <input v-model="phone" type="text" name="phone" id="phone"
                            ...
                            class="px-2 py-1 mt-2 bg-[#eaeaea] rounded focus:outline-none border-2 border-gray-100 focus:border-blue-500">
                        <div class="message h-6">
                            <small v-if="errors.phone" class="text-red-500 font-semibold">{{ errors.phone[0]
                                }}</small>
                        </div>
                    </div>
                </form>
                <button @click="userAdd" type="button"
